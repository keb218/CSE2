...
public class Root {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(
            ...
            double guess0 = (2*guess*guess*guess+x)/(3*guess*guess); //guess begins to become more accurate
            ...
            double crudeAnswer = guess4*guess4*guess4; //the number most accurate is defined as crude answer
        //print out the cube root and the close guess of the crude when cubed    
        System.out.println(
            "The cube root is " + guess4 + ":"
            + guess4 + "*" +guess4+ "*" +guess4 + " = "
            + crudeAnswer+ ".");
